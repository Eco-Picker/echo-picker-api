...
class NewsletterService(private val geminiManager: GeminiManager) {
    ...
    fun getEducationalContents(offset: Int, limit: Int): List<Newsletter> {
        return listOf(
            Newsletter(
                id = 1L,
            ...
            Newsletter(
                ...
                content = "Discover practical tips for minimizing plastic use in your daily life. This article provides strategies for reducing plastic waste and opting for sustainable alternatives.",
                category = NewsletterCategory.EDUCATION,
    ...
    fun getNewsList(offset: Int, limit: Int): List<Newsletter> {
        return listOf(
            Newsletter(
                id = 3L,
            ...
            Newsletter(
                ...
                content = "A recent report shows that the city has met its plastic waste reduction goals ahead of schedule. Find out how these achievements were accomplished and what comes next.",
                category = NewsletterCategory.NEWS,
                author = "James Taylor",
                publishedAt = ZonedDateTime.now(),
    ...
    fun getEvents(offset: Int, limit: Int): List<Newsletter> {
        return listOf(
            Newsletter(
                id = 5L,
            ...
            Newsletter(
                ...
                content = "Attend our workshop to learn the best practices for effective recycling. The workshop will cover how to sort waste correctly and reduce contamination in recycling bins.",
                category = NewsletterCategory.EVENT,
                author = "Workshop Facilitator",
                publishedAt = ZonedDateTime.now(),
                source = "Eco Workshops"
            )
        )
    }
